...
import ArcNode from './components/ArcNode.vue'
...
const install = (Vue) => {
  ...
  Vue.component(NODE_TYPES.DOT_NODE, OperatorNode)
  Vue.component(NODE_TYPES.PLUS_MINUS_NODE, OperatorNode)
  Vue.component(NODE_TYPES.FACTORIAL_NODE, OperatorNode)
  Vue.component(NODE_TYPES.ALMOST_EQUAL_NODE, OperatorNode)
  Vue.component(NODE_TYPES.CIRCLED_DOT_NODE, OperatorNode)
  Vue.component(NODE_TYPES.ARC_NODE, ArcNode)
  Vue.component(NODE_TYPES.INFINITY_NODE, OperatorNode)
  Vue.component(NODE_TYPES.TOP_LINE_NODE, ArcNode)
  Vue.component(NODE_TYPES.TOP_RIGHT_ARROW_NODE, ArcNode)
  Vue.component(NODE_TYPES.TOP_DOT_NODE, ArcNode)
  Vue.component(NODE_TYPES.SLANTED_FRACTION_NODE, FractionsNode)
