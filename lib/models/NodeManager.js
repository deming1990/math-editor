...
const NODE_CONTRS = {
  ...
  [NODE_TYPES.DOT_NODE]: OperatorNode,
  [NODE_TYPES.PLUS_MINUS_NODE]: OperatorNode,
  [NODE_TYPES.FACTORIAL_NODE]: OperatorNode,
  [NODE_TYPES.ALMOST_EQUAL_NODE]: OperatorNode,
  [NODE_TYPES.CIRCLED_DOT_NODE]: OperatorNode,
  [NODE_TYPES.ARC_NODE]: UnaryOperatorNode,
  [NODE_TYPES.INFINITY_NODE]: OperatorNode,
  [NODE_TYPES.TOP_LINE_NODE]: UnaryOperatorNode,
  [NODE_TYPES.TOP_RIGHT_ARROW_NODE]: UnaryOperatorNode,
  [NODE_TYPES.TOP_DOT_NODE]: UnaryOperatorNode,
  [NODE_TYPES.SLANTED_FRACTION_NODE]: FractionsNode
}
...
class NodeManager {  
  ...
  static isUnaryOperatorNode(node) {
    return node && (node instanceof UnaryOperatorNode)
  }
