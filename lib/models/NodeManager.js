...
import LeftBracketNode from './LeftBracketNode'
import RightBracketNode from './RightBracketNode'
import AbsoluteNode from './AbsoluteNode'
import LeftAbsoluteNode from './LeftAbsoluteNode'
import RightAbsoluteNode from './RightAbsoluteNode'
...
const NODE_CONTRS = {
  ...
  [LeftBracketNode.compType]: LeftBracketNode,
  [RightBracketNode.compType]: RightBracketNode,
  [AbsoluteNode.compType]: AbsoluteNode,
  [LeftAbsoluteNode.compType]: LeftAbsoluteNode,
  [RightAbsoluteNode.compType]: RightAbsoluteNode,
...
class NodeManager {
  ...
  static LeftBracketNode = LeftBracketNode.compType
  static RightBracketNode = RightBracketNode.compType
  static AbsoluteNode = AbsoluteNode.compType
  static LeftAbsoluteNode = LeftAbsoluteNode.compType
  static RightAbsoluteNode = RightAbsoluteNode.compType
  ...
  static isNumberNode(node) {
    return node && node instanceof NumberNode
  }
}
