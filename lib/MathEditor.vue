...
Vue.component(NODE_TYPES.LEFT_BRACKET_NODE, BracketNode)
Vue.component(NODE_TYPES.RIGHT_BRACKET_NODE, BracketNode)
Vue.component(NODE_TYPES.ABSOLUTE_NODE, BracketNode)
Vue.component(NODE_TYPES.LEFT_ABSOLUTE_NODE, BracketNode)
Vue.component(NODE_TYPES.RIGHT_ABSOLUTE_NODE, BracketNode)
