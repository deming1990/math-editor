...
export const NODE_TYPES = {
  ...
  PI_NODE: 'pi-node',
  SINGLE_SQRT_NODE: 'single-sqrt-node'
}
...
export const MATH_NODES = {
  ...
  [MATH_NODE_CATEGORYS.RELATIONAL.code]: [
    ...
    },
    {
      ...
      iconText: OPERATOR_CHARS[NODE_TYPES.PERP_NODE]
    },
    {
      compType: NODE_TYPES.SWUNG_DASH_NODE,
      iconText: OPERATOR_CHARS[NODE_TYPES.SWUNG_DASH_NODE]
    },
    {
  ...
  [MATH_NODE_CATEGORYS.OTHER.code]: [
    ...
    },
    {
      ...
      iconText: OPERATOR_CHARS[NODE_TYPES.PI_NODE]
    },
  ]
}
