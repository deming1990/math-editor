...
export const NODE_TYPES = {
  ...
  SQRT_NODE: 'sqrt-node',
  DOT_NODE: 'dot-node',
  PLUS_MINUS_NODE: 'plus-minus-node',
  FACTORIAL_NODE: 'factorial-node',
  ALMOST_EQUAL_NODE: 'almost-equal-node',
  CIRCLED_DOT_NODE: 'circled-dot-node',
  ARC_NODE: 'arc-node',
  INFINITY_NODE: 'infinity-node',
  TOP_LINE_NODE: 'top-line-node',
  TOP_RIGHT_ARROW_NODE: 'top-right-arrow-node',
  TOP_DOT_NODE: 'top-dot-node',
  SLANTED_FRACTION_NODE: 'slanted-fraction-node'
}
...
export const OPERATOR_CHARS = {
  ...
  [NODE_TYPES.DOT_NODE]: '&middot;',
  [NODE_TYPES.PLUS_MINUS_NODE]: '&plusmn;',
  [NODE_TYPES.FACTORIAL_NODE]: '!',
  [NODE_TYPES.ALMOST_EQUAL_NODE]: '&asymp;',
  [NODE_TYPES.CIRCLED_DOT_NODE]: '&#8857;',
  [NODE_TYPES.ARC_NODE]: '&#8978;',
  [NODE_TYPES.INFINITY_NODE]: '&infin;'
}
...
export const MATH_NODES = {
  [MATH_NODE_CATEGORYS.OPERATOR.code]: [
    ...
    {
      compType: NODE_TYPES.DOT_NODE,
      iconText: OPERATOR_CHARS[NODE_TYPES.DOT_NODE]
    },
    {
      compType: NODE_TYPES.PLUS_MINUS_NODE,
      iconText: OPERATOR_CHARS[NODE_TYPES.PLUS_MINUS_NODE]
    },
    {
      compType: NODE_TYPES.FACTORIAL_NODE,
      iconText: OPERATOR_CHARS[NODE_TYPES.FACTORIAL_NODE]
    },
    {
      compType: NODE_TYPES.SLANTED_FRACTION_NODE,
      iconImage: require('./assets/images/math-slanted-fraction.png')
    }
  ],
  [MATH_NODE_CATEGORYS.RELATIONAL.code]: [
    ...
    },
    {
      ...
      iconImage: require('./assets/images/math-similar.svg')
    },
    {
      compType: NODE_TYPES.EQUAL_OR_APPROXIMATELY_EQUAL_NODE,
      iconImage: require('./assets/images/math-congruent.svg')
    },
    {
      compType: NODE_TYPES.ALMOST_EQUAL_NODE,
      iconText: OPERATOR_CHARS[NODE_TYPES.ALMOST_EQUAL_NODE]
    }
  ],
  [MATH_NODE_CATEGORYS.ELLIPSIS.code]: [
    ...
    {
      compType: NODE_TYPES.CIRCLED_DOT_NODE,
      iconText: OPERATOR_CHARS[NODE_TYPES.CIRCLED_DOT_NODE]
    },
    {
      compType: NODE_TYPES.ARC_NODE,
      iconText: OPERATOR_CHARS[NODE_TYPES.ARC_NODE]
    },
    {
      compType: NODE_TYPES.INFINITY_NODE,
      iconText: OPERATOR_CHARS[NODE_TYPES.INFINITY_NODE]
    },
    {
      compType: NODE_TYPES.TOP_LINE_NODE,
      iconImage: require('./assets/images/math-top-line.png')
    },
    {
      compType: NODE_TYPES.TOP_RIGHT_ARROW_NODE,
      iconImage: require('./assets/images/math-top-right-arrow.png')
    },
    {
      compType: NODE_TYPES.TOP_DOT_NODE,
      iconImage: require('./assets/images/math-top-dot.png')
    }
  ],
